...
logging.basicConfig(filename=LOGS, level=logging.ERROR, format="""%(asctime)s FILE: %(filename)s
                                          IN: %(funcName)s MESSAGE: %(message)s""", filemode="w")
...
def ask_gpt(messages):
    ...
    try:
        ...
        # если всё успешно - считаем количество токенов, потраченных на ответ, возвращаем статус,
        # ответ, и количество токенов в ответе
